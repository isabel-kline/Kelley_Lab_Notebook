...
|                                     |       |
|-------------------------------------|------:|
| **final pool concentration (nM):**  |    12 |
| **final pool volume (µL):**         |   100 |
| **total volume of libraries (µL):** | 84.20 |
| **volume of dilution buffer (µL)**  | 15.80 |

|             |             |                 |
|:-----------:|-------------|-----------------|
| **Tube ID** | Predilution | **Volume (ul)** |
|      1      | 1           | 2.23            |
|      2      | 1           | 2.30            |
|      3      | 1           | 3.64            |
|      4      | 1           | 4.17            |
...
| **final pool concentration (nM):**  |    12 |
| **final pool volume (µL):**         |   100 |
| **total volume of libraries (µL):** | 95.19 |
| **volume of dilution buffer (µL)**  |  4.81 |

|             |                 |                                    |
|:-----------:|:---------------:|:----------------------------------:|
| **Tube ID** | **Predilution** | **Volume of Library to Pool (uL)** |
|     25      |        3        |                3.48                |
|     26      |        3        |                4.16                |
|     27      |        3        |                5.94                |
|     28      |        3        |                4.69                |
...
| **final pool concentration (nM):**  |    12 |
| **final pool volume (µL):**         |   100 |
| **total volume of libraries (µL):** | 94.02 |
| **volume of dilution buffer (µL)**  |  5.98 |
...
| **final pool concentration (nM):**  |    12 |
| **final pool volume (µL):**         |   100 |
| **total volume of libraries (µL):** | 90.99 |
| **volume of dilution buffer (µL)**  |  9.01 |
